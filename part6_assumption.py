...
Parts 1 to 5 ran them. Where the change goes depends on the assumption:

  * users per world: pass users= to simulate(), as the example below does.
  * something about what the recommender shows: write a changed recommender in this file, and
    pass it to simulate() for the "after" runs.
